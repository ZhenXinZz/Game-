...
class Game:
    def __init__(self):  # 游戏初始化(initialisation du jeu)
        pygame.init()
        pygame.display.set_mode((698,484))
        pygame.display.set_caption('Nian')
        self.bg=pygame.image.load(r'C:\Users\eleve\Documents\jeu\ressources\imageetsprite\bg.jpg')
        icon=pygame.image.load(r'C:\Users\eleve\Documents\jeu\ressources\imageetsprite\icon.jpg')
        pygame.display.set_icon(icon)
        self.start=pygame.image.load(r'C:\Users\eleve\Documents\jeu\ressources\imageetsprite\开始游戏.png')
...
#  keys.pygame.key.get_pressed()  现在keys为0 和 1组成的列表 他会根据按键而变化
#   if keys[pygame.K_DOWN]:
#      人物.rect.y+=10
#    if keys[pygame.K_UP]:
#       人物.rect