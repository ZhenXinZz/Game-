...
class Game:
    def __init__(self):  # 游戏初始化(initialisation du jeu)
        ...
        self.bg=pygame.image.load(r'G:\Thonny\jeu\ressources\imageetsprite\bg.jpg')
        icon=pygame.image.load(r'G:\Thonny\jeu\ressources\imageetsprite\icon.jpg')
        pygame.display.set_icon(icon)
        self.start=pygame.image.load(r'G:\Thonny\jeu\ressources\imageetsprite\开始游戏.png')
